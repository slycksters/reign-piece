export const TITLES = [
  ...
  },
  {
    ...
    stats: {
      ...
      dashPower: 0.35,
      lifesteal: 0.0575,
      cooldownReduction: 0.085,
    },
    requirements: [
      { name: 'Defeat Starrk 50 times' },
      { name: `Obtain Starrk's Coat` },
      { name: 'Equip Panthera' },
    ],
  },
  {
    id: 'soul-society-betrayer',
    name: `Soul Society's Betrayer`,
    stats: {
      overallDamage: 0.725,
      ...
      droprate: 0.165,
      lifesteal: 0.05,
      cooldownReduction: 0.0925,
    },
    requirements: [
      { name: 'Defeat Aizen 75 times' },
      { name: `Obtain Aizen's Coat` },
      { name: 'Equip Manipulator' },
    ],
  },
  {
    id: 'shadow-eminence',
    name: 'Shadow Eminence',
    stats: {
      overallDamage: 0.755,
      damageReduction: 0.55,
      movementSpeed: 0.55,
    ...
    requirements: [
      { name: 'Defeat Shadow 50 times' },
      { name: `Obtain Shadow's Outfit` },
      { name: 'Equip Nightwalker' },
    ],
  },
  {
    id: 'sovereign-eminence',
    name: 'Sovereign Eminence',
    stats: {
      overallDamage: 0.8,
      damageReduction: 0.6,
      movementSpeed: 0.6,
    ...
    requirements: [
      { name: 'Defeat Sovereign Shadow 25 times' },
      { name: `Obtain Sovereign Shadow's Outfit` },
      { name: 'Equip Nightwalker' },
    ],
  },
];
